...
$$.PongGame = {"":
 ["ball", "player2", "player1", "lastPowerUp", "highscore", "score", "loop", "renderer", "input", "sound", "showOutlines", "bgStyle", "debugMode", "_rect", "clockTick", "timer", "entities"],
 super: "Game"
};
...
$$.PongGameRenderer = {"":
 ["powerUpRenderer", "rect", "assetManager", "defaultRenderer", "ctx", "game", "targetId"],
...
$$.CanvasGameRenderer = {"":
 ...
 CanvasGameRenderer$1: function(targetId) {
  $.query('#' + $.S(this.targetId)).getContext$1('2d').get$canvas().get$rect().then$1(new $.anon(this));
  this.defaultRenderer = $.DefaultCanvasRenderer$(this);
 }
};

$$.DefaultCanvasRenderer = {"":
 ["gr"],
 super: "Object"
};
...
$$.anon = {"":
 ...
 super: "Closure",
 $call$1: function(r) {
  var t1 = $.Rectangle$(r.get$bounding().get$top(), r.get$bounding().get$left(), r.get$bounding().get$right(), r.get$bounding().get$bottom());
  this.this_0.set$rect(t1);
 }
};
...
$.HtmlGameSound$ = function() {
  return new $.HtmlGameSound('Sounds/', true);
};
...
$.DefaultCanvasRenderer$ = function(gr) {
  return new $.DefaultCanvasRenderer(gr);
};
...
$.PongGameRenderer$ = function(targetId) {
  var t1 = new $.PongGameRenderer(null, null, null, null, null, null, targetId);
...
$.main = function() {
  var sound = $.HtmlGameSound$();
  var game = $.PongGame$withServices(sound, $.HtmlGameInput$(), $.PongGameRenderer$('surface'), $.HtmlGameLoop$());
  sound.enabled = true;
...
$.HtmlGameInput$ = function() {
  return new $.HtmlGameInput(null, null, null);
};
...
$.PongGame$withServices = function(sound, input, renderer, loop) {
  var t1 = new $.PongGame(null, null, null, 5, 0, 0, loop, renderer, input, sound, false, 'rgba(0, 0, 0, 0.85)', false, null, null, null, null);
