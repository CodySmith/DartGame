...
Game.prototype.start = function() {
  print$("starting game");
  get$$window().noSuchMethod("requestAnimationFrame", [this.get$loop()]);
}
...
PongGame.prototype.newGame = function() {
  this.ball.y = (0);
  if (Math.random() > (0.5)) this.ball.momentum.yVel = Math.random() * (200);
  else this.ball.momentum.yVel = Math.random() * (-200);
